...
ENEMY_FISH_TYPES = [
    ...
    ("Fishright10.png", "Fishleft10.png", 1, 0, 7),  # Loại 1: xuất hiện từ level 0-7
    ("Fishright2.png", "Fishleft2.png", 2, 0, 8),    # Loại 2: xuất hiện từ level 0-8
    ("Fishright1.png", "Fishleft1.png", 7, 0, 9),    # Loại 3: xuất hiện từ level 0-9
    ("Fishright3.png", "Fishleft3.png", 9, 0, 99),   # Loại 4: xuất hiện từ level 3-10
    ...
    ("sharkleft1.png", "shark1.png", 30, 25, 99)     # Cá mập: xuất hiện từ level 14+
]
